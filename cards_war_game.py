"""
War_game: Traditional rules. Two players. Random cards for each player in the beginning.
After war cards are coming back to the winner. Checking hazard rules after certain number of games.
"""
